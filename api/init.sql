...
--
-- Name: role role_id_project_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.role
    ADD CONSTRAINT role_id_project_fkey FOREIGN KEY (id_project) REFERENCES public.project(id) ON DELETE CASCADE;
